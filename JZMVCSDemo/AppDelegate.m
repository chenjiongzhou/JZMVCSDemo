...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    JZBaseScene *scene = [[JZBaseScene alloc] initSceneWithViewClass:[JZHomeView class] controllerClass:[JZBaseViewController class] store:[JZHomeStore class]];
    UIViewController *home = [JZMediator viewControllerWithScene:scene contex:nil];
